	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.ftl"><img src="assets/images/logo.png" alt="Progressus HTML5 template"></a>
			</div>
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="sidebar-left.ftl">Left Sidebar</a></li>
							<li class="active"><a href="sidebar-right.ftl">Right Sidebar</a></li>
						</ul>
					</li>
					<li><a href="contact.ftl">Contact</a></li>
					<li><a class="btn" href="signin.ftl">SIGN IN / SIGN UP</a></li>
				</ul>
			</div><!--/.nav-collapse -->
		</div>
	</div> 
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<a href="sidebar-right.ftl">Sidebar</a> |
								<a href="contact.ftl">Contact</a> |
								<b><a href="signup.ftl">Sign up</a></b>
							</p>
						</div>
					</div>
