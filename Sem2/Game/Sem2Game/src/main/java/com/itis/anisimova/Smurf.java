...
/**
 * Created by Julia_2 on 28.05.2016.
 */
public class Smurf extends Pane {
    ImageView imageView;
    int count = 3;
    int columns = 3;
    int offsetX = 0;
    ...
    public Smurf(ImageView imageView){
        this.imageView = imageView;
        this.imageView.setViewport(new Rectangle2D(offsetX,offsetY,width,height));
        animation = new MyAnimation(imageView, Duration.millis(200),count,columns,offsetX,offsetY,width,height);
